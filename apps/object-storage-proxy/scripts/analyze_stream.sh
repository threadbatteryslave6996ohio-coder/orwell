...
# The stream worker is a mode of the object-storage-proxy jar. Launch the jar with
...
JAVA_WORKER_JAR="${STREAM_ANALYSIS_WORKER_JAR:-/opt/s3-proxy/publish/object-storage-proxy.jar}"
