...
class ObjectStorageProxyEnvsTest {
    ...
    void exposesResolvedValuesAsSpringApplicationProperties() {
        Env env = ObjectStorageProxyEnvs.ENV.schema().from(Map.ofEntries(
                ...
                Map.entry("OBJECT_STORAGE_MANAGEMENT_USERNAME", "admin"),
                Map.entry("OBJECT_STORAGE_MANAGEMENT_PASSWORD", "password"),
                Map.entry("OBJECT_STORAGE_MANAGEMENT_SESSION_SECRET", "session-secret"),
        ...
        assertEquals(Map.ofEntries(
                ...
                Map.entry("object-storage.management.username", "admin"),
                Map.entry("object-storage.management.password", "password"),
                Map.entry("object-storage.management.session-secret", "session-secret"),
