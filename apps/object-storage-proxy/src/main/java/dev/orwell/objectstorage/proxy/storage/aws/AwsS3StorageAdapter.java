package dev.orwell.objectstorage.proxy.storage.aws;

import dev.orwell.objectstorage.proxy.ProxyProperties;
...
@Component
@ConditionalOnProperty(name = "object-storage.storage.provider", havingValue = "aws", matchIfMissing = true)
