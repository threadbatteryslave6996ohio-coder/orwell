package dev.orwell.objectstorage.proxy.streaming;
...
import dev.orwell.objectstorage.proxy.ObjectStorageProxyEnvs;
...
public final class AnalysisWorker {
     ...
     * validate the full {@link ObjectStorageProxyEnvs} schema: a malformed value for an unrelated
    ...
    private static String loadEndpoint() {
        ...
        EnvOption<String> option = ObjectStorageProxyEnvs.STREAM_ANALYSIS_ENDPOINT;
