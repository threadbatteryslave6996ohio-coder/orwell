...
public final class ObjectStorageProxyClient {
    ...
    public ObjectStorageProxyClient(RestClient restClient) {
    ...
    /** Shared request wrapper: preserves a thrown {@link ObjectStorageProxyClientException}, and maps any
    ...
    private static <T> T call(String operation, Supplier<T> action) {
        try {
            return action.get();
        } catch (ObjectStorageProxyClientException exception) {
            throw exception;
        } catch (RestClientException exception) {
            throw new ObjectStorageProxyClientException("Cannot complete " + operation + " with proxy.", exception);
        }
    }

    private static RestClient.ResponseSpec.ErrorHandler rejected(String operation) {
        return (request, response) -> {
            throw new ObjectStorageProxyClientException(
