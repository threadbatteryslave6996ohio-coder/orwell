...
import dev.orwell.objectstorage.proxy.streaming.AnalysisWorker;
...
public class ObjectStorageProxyApplication {
    ...
    public static final AppServer SERVER =
            new AppServer(ObjectStorageProxyApplication.class, "object-storage-proxy", ObjectStorageProxyEnvs.ENV);
