...
- `alerting/`: Java alert server
- `detection/`: Java detection service
- `streaming/`: Java stream worker plus shell scripts

## Runtime

- `proxy`: Spring Boot service packaged as a jar
- `alerting`: executable jar
- `detection`: executable jar
...
The EC2 user-data script installs Java 17, Maven, Nginx, Docker, and ffmpeg, then builds `bucket/pom.xml` and installs the generated jars.
